      ...
      <div class="col-md-10">
        <div align="center" class="panel panel-default panel-sobre">
          <div class="panel-body">
            ...
            <h2 class="hidden-md hidden-lg" align="center"><u>ATUALIZA TRABALHO</u></h2><br>
            <h2 class="hidden-sm hidden-xs" align="left"><u>ATUALIZA TRABALHO</u></h2><br>

             <form name="formulario" method="post" action="<? echo base_url(). 'admin/insereTrabalho' ?>">
